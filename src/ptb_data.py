"""
from Pytorch-NCE (include LICENSE)
"""
...
from src.ptb_vocab import get_vocab
...
class Corpus(object):
    def __init__(self, path, vocab_path=None, batch_size=1, shuffle=False,
                 pin_memory=False, update_vocab=False, max_size=10002):
        ...
        self.vocab = get_vocab(path, ['train.txt'], max_size=max_size)
